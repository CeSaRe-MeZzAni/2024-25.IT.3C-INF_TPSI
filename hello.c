...
int main() {
    ...
    int ES3 = NOT(AND(A, OR(A, B)));
    printf("Il valore di uscita della porta ES3 è: %d\n", ES3);
    
    int taut = NOT(NOT(AND(OR(AND(A, B), AND(C, D)), AND(E, F))));
    printf("Il valore di uscita della porta taut è: %d\n", taut);
    }
